...
function createMotionComponent({ preloadedFeatures: preloadedFeatures2, createVisualElement: createVisualElement2, useRender, useVisualState: useVisualState2, Component: Component3 }) {
  ...
  function MotionComponent(props, externalRef) {
    let MeasureLayout2;
    const configAndProps = __spreadProps(__spreadValues(__spreadValues({}, (0, import_react11.useContext)(MotionConfigContext)), props), {
    ...
    return (0, import_jsx_runtime.jsxs)(MotionContext.Provider, { value: context, children: [MeasureLayout2 && context.visualElement ? (0, import_jsx_runtime.jsx)(MeasureLayout2, __spreadValues({ visualElement: context.visualElement }, configAndProps)) : null, useRender(Component3, props, useMotionRef(visualState, context.visualElement, externalRef), visualState, isStatic, context.visualElement)] });
  }
...
function createUseRender(forwardMotionProps = false) {
  const useRender = (Component3, props, ref, { latestValues }, isStatic) => {
    ...
    const elementProps = Component3 !== import_react14.Fragment ? __spreadProps(__spreadValues(__spreadValues({}, filteredProps), visualProps), { ref }) : {};
    const { children } = props;
    const renderedChildren = (0, import_react14.useMemo)(() => isMotionValue(children) ? children.get() : children, [children]);
    return (0, import_react14.createElement)(Component3, __spreadProps(__spreadValues({}, elementProps), {
...
var MainThreadAnimation = class extends BaseAnimation {
  constructor(_a) {
    var _b = _a, { KeyframeResolver: KeyframeResolver$1 = KeyframeResolver } = _b, options = __objRest(_b, ["KeyframeResolver"]);
    super(options);
    this.holdTime = null;
    this.startTime = null;
...
var AcceleratedAnimation = class extends BaseAnimation {
  ...
  initPlayback(keyframes2, finalKeyframe) {
    ...
    if (requiresPregeneratedKeyframes(this.options)) {
      const _a2 = this.options, { onComplete, onUpdate, motionValue: motionValue3 } = _a2, options = __objRest(_a2, ["onComplete", "onUpdate", "motionValue"]);
    ...
    const animation = animateStyle(motionValue2.owner.current, name, keyframes2, __spreadProps(__spreadValues({}, this.options), { duration, times, ease: ease2 }));
  ...
  stop() {
    ...
    if (this.time) {
      const _a = this.options, { motionValue: motionValue2, onUpdate, onComplete } = _a, options = __objRest(_a, ["motionValue", "onUpdate", "onComplete"]);
      const sampleAnimation = new MainThreadAnimation(__spreadProps(__spreadValues({}, options), {
        keyframes: keyframes2,
        duration,
        type,
...
function MeasureLayout(props) {
  ...
  return (0, import_jsx_runtime2.jsx)(MeasureLayoutWithContext, __spreadProps(__spreadValues({}, props), { layoutGroup, switchLayoutGroup: (0, import_react18.useContext)(SwitchLayoutGroupContext), isPresent: isPresent2, safeToRemove }));
}
...
function MotionConfig(_a) {
  ...
  config = __spreadValues(__spreadValues({}, (0, import_react24.useContext)(MotionConfigContext)), config);
...
var LayoutGroup = ({ children, id: id4, inherit = true }) => {
  ...
  const memoizedContext = (0, import_react29.useMemo)(() => __spreadProps(__spreadValues({}, context.current), { forceRender }), [key]);
...
function ReorderGroup(_a, externalRef) {
  ...
  return (0, import_jsx_runtime9.jsx)(Component3, __spreadProps(__spreadValues({}, props), { ref: externalRef, ignoreStrict: true, children: (0, import_jsx_runtime9.jsx)(ReorderContext.Provider, { value: context, children }) }));
}
...
function ReorderItem(_a, externalRef) {
  ...
  return (0, import_jsx_runtime10.jsx)(Component3, __spreadProps(__spreadValues({ drag: axis }, props), { dragSnapToOrigin: true, style: __spreadProps(__spreadValues({}, style), { x: point2.x, y: point2.y, zIndex }), layout: layout2, onDrag: (event, gesturePoint) => {
...
function useSpring(source, config = {}) {
  ...
  const startAnimation = () => {
    ...
    stopAnimation2();
    activeSpringAnimation.current = animateValue(__spreadProps(__spreadValues({
...
function createAnimationsFromSequence(sequence, _a = {}, scope) {
  ...
  for (let i = 0; i < sequence.length; i++) {
    ...
    const resolveValueSequence = (valueKeyframes, valueTransition, valueSequence, elementIndex = 0, numElements = 0) => {
      ...
      const _a2 = valueTransition, { delay: delay2 = 0, times = defaultOffset(valueKeyframesAsList), type = "keyframes" } = _a2, remainingTransition = __objRest(_a2, ["delay", "times", "type"]);
...
function animateElements(elementOrSelector, keyframes2, options, scope) {
  ...
  for (let i = 0; i < numElements; i++) {
    ...
    animations2.push(...animateTarget(visualElement, __spreadProps(__spreadValues({}, keyframes2), { transition }), {}));
  }
...
function useCycle(...items) {
  ...
  const runCycle = (0, import_react41.useCallback)((next) => {
...
function startOptimizedAppearAnimation(element, name, keyframes2, options, onReady) {
  ...
  if (!readyAnimation) {
    readyAnimation = animateStyle(element, name, [keyframes2[0], keyframes2[0]], { duration: 1e4, ease: "linear" });
